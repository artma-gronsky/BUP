...
export class FileUpload extends Component {
    ...
    static defaultProps = {
        ...
        fileLimitMessageSummary: 'Yoy can\'t upload more files, ',
        fileLimitMessageDetail: 'maximum upload file amount is {0}.',
        style: null,
        className: null,
    ...
    onFileSelect(event) {
        ...
        if (this.props.fileLimit && (this.state.files?.length ?? 0) === this.props.fileLimit){
            return
        }
        ...
        if(files.length > this.props.fileLimit){
            return;
        }
    ...
    onDrop(event) {
        ...
        if (!this.props.disabled) {
            ...
            let allowDrop = (files && files.length !== 0);
